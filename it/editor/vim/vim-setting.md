...
hi cBinaryOperatorError     gui=NONE cterm=bold  ctermfg=DarkRed
hi cLogicalOperatorError    gui=NONE cterm=bold  ctermfg=DarkRed
```
gvim的设置如下：
```
"========================================================
...
" Math Operator
hi cMathOperator            guifg=Green
hi cPointerOperator         guifg=Green
hi cLogicalOperator         guifg=Green
hi cBinaryOperator          guifg=Green
hi cBinaryOperatorError     guifg=Red
hi cLogicalOperatorError    guifg=Red
```
